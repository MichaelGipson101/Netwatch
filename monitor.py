...
<div class="shell">
  ...
  <nav>
    ...
    <div class="nav-right">
      ...
      <span id="nav-auth" style="display:inline-flex;align-items:center;gap:8px"></span>
  ...
  <div class="view" id="view-topology">
    ...
    <div class="topo-web" id="topo-web" style="display:none">
      <!-- Status legend - hidden by default, opens via the ? button -->
      ...
      <div class="topo-legend" id="topo-legend">
        ...
        <div class="topo-legend-section">
          ...
          <div class="topo-legend-row"><svg class="topo-legend-svg-line" width="28" height="6" viewBox="0 0 28 6"><line x1="2" y1="3" x2="26" y2="3" stroke="#5b8eff" stroke-width="2" stroke-linecap="round"/></svg>Ethernet</div>
          <div class="topo-legend-row"><svg class="topo-legend-svg-line" width="28" height="6" viewBox="0 0 28 6"><line x1="2" y1="3" x2="26" y2="3" stroke="#3dc7c0" stroke-width="2" stroke-dasharray="1,3" opacity="0.85" stroke-linecap="round"/></svg>WiFi</div>
          <div class="topo-legend-row"><svg class="topo-legend-svg-line" width="28" height="6" viewBox="0 0 28 6"><line x1="2" y1="3" x2="26" y2="3" stroke="#a872d6" stroke-width="2" stroke-dasharray="4,2" stroke-linecap="round"/></svg>Fiber</div>
          <div class="topo-legend-row"><svg class="topo-legend-svg-line" width="28" height="6" viewBox="0 0 28 6"><line x1="2" y1="3" x2="26" y2="3" stroke="#f0a93b" stroke-width="2" stroke-dasharray="8,3" stroke-linecap="round"/></svg>Power</div>
          <div class="topo-legend-row"><svg class="topo-legend-svg-line" width="28" height="6" viewBox="0 0 28 6"><line x1="2" y1="3" x2="26" y2="3" stroke="#b07cd6" stroke-width="1.5" stroke-dasharray="3,2" stroke-linecap="round"/></svg>Virtual (VM &#8594; host)</div>
          <div class="topo-legend-row"><svg class="topo-legend-svg-line" width="28" height="6" viewBox="0 0 28 6"><line x1="2" y1="3" x2="26" y2="3" stroke="#9b998f" stroke-width="2" stroke-dasharray="3,3" opacity="0.6" stroke-linecap="round"/></svg>Offline / idle endpoint</div>
        </div>
      </div>
  ...
  <div class="footer">
    <span>netwatch v3.37 - raspberry pi</span>
...
<div class="modal-overlay" id="inv-edit-overlay">
...
<div class="modal-overlay" id="discover-overlay">
...
def make_handler(host_manager, settings, config_path, incident_log=None, auth_manager=None, inventory_db=None):
...
def start_web_server(host_manager, settings, config_path, port, stop_event, incident_log=None, auth_manager=None, inventory_db=None):
